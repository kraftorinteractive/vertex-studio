            ...
            <div className="contact-page__container">
              <div className="contact-page__info">
                ...
                <div className="contact-page__direct">
                  <a className="button button--outline" href="https://wa.me/919028791816?text=Hi%20Vertex%20Studio%2C%20I%20am%20interested%20in%20discussing%20a%20project%20with%20you." target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    WhatsApp Us <img className="button__arrow-icon" src="/assets/Group 51.svg" alt="" aria-hidden="true" style={{ filter: 'brightness(0) saturate(100%) invert(56%) sepia(90%) saturate(1637%) hue-rotate(344deg) brightness(101%) contrast(101%)' }} />
                  </a>
                </div>
              </div>
