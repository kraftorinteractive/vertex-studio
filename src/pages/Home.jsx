...
const assets = '/assets/';
const services = [
  ['Group 34.svg', 'Brand Identity', 'Distinctive branding that builds recognition and trust.'],
  ['Group 36.svg', 'UI/UX Design', 'User-focused digital experiences designed for clarity and conversion.'],
  ['Group 38.svg', 'Print Design', 'Professional collateral and packaging that strengthens your brand.'],
  ['Group 81.svg', 'Social Media Design', 'Creative visual content designed to increase engagement and consistency.'],
  ['Group 96.svg', 'Website Design & Development', 'Modern, responsive websites built for performance and growth.'],
  ['Group 27.svg', 'Design Consultation', 'Helping businesses make better design decisions with strategic guidance.'],
  ['Group 29.svg', 'Video Editing', 'Short-form videos to grab attention and boost engagement.'],
];
...
export default function Home() {
  return <ReactFullpage
    ...
    <section className="section hero">
      <video className="hero__video" autoPlay muted loop playsInline aria-hidden="true"><source src="/video.mp4" type="video/mp4" /></video>
      ...
      <div className="hero__clients" aria-label="Selected clients">
        <img src={`${assets}White transparent@2x.png`} alt="Akiya" />
        <img src={`${assets}White-1@2x.png`} alt="Arick Imperial" />
        <img src={`${assets}Choicos Choice - White on Blue0@2x.png`} alt="Chicco Choice" />
        <img src={`${assets}Light@2x.png`} alt="Honeydew Kingdom" />
        <img src={`${assets}HC Logo Negative@2x.png`} alt="HC" />
        <img src={`${assets}White@2x.png`} alt="Kaashie" />
        <span className="client-name">MindNMuscl</span>
      </div>
    </section>
